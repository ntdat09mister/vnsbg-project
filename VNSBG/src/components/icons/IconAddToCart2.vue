<template>
    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 243.5 243.5" style="enable-background:new 0 0 243.5 243.5;" width="100px" height="100px" xml:space="preserve">
        <g>
